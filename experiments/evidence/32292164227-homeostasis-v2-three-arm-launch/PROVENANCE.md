# Provenance — artifact 9379919939 (`homeostasis-v2-three-arm-launch-restricted`)
...
`2026-09-18T19:18:36Z`. Owner ruling 2026-09-18 (see
...
| field | value |
|---|---|
| artifact id | `9379919939` |
| artifact name | `homeostasis-v2-three-arm-launch-restricted` |
| workflow run id | `32292164227` |
| run url | https://github.com/NumbScholary/CapAge/actions/runs/32292164227 |
| head branch | `agent/homeostasis-v2-three-arm-launch` |
| head sha | `2f24223f88d56c168a3d3550b7490100bcc05ab2` |
| artifact created | `2026-08-19T19:18:36Z` |
| artifact expiry (GitHub deletion) | `2026-09-18T19:18:36Z` |
| zip size as retrieved | 9,410 bytes |
| zip sha256 | `c6a80f042101cb884c5ff32d45f025f64f79f0e65da816cd85e02294f3d06e81` |
| files | 5 |
| extracted bytes | 114,286 |
| retrieved | 2026-09-18, read-only, `gh api repos/NumbScholary/CapAge/actions/artifacts/9379919939/zip` |

## What is authoritative

`raw/9379919939.zip` is the byte authority: it is the artifact exactly as GitHub
